  ...
  return (
    <>
      <div className="post-comment-item-box" key={comment.id}>
        <div className="profile profile-small" style={{backgroundImage: `url("${comment.commentsUser.profile}")`}}></div>
        <div className="post-comment-item-comment">
          <div className="post-comment-item-comment-info">
            <p className='post-comment-item-item-nick'>{comment.commentsUser.nick}</p>
          ...
          <div className="post-comment-item-reply-box">
            ...
            }
            {
              ...
              (comment.commentReplies && comment.commentReplies?.length > 0) &&  comment.commentReplies.map(item => {
